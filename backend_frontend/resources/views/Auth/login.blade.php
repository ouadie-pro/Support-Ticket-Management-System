        ...
        <div class="w-full max-w-md">
            ...
            <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl p-6 sm:p-8">
                <div class="text-center mb-6 sm:mb-8">
                    <h2 class="text-xl sm:text-2xl font-bold text-gray-900">Bon retour</h2>
                    <p class="text-gray-500 mt-2 text-sm sm:text-base">Connectez-vous à votre compte</p>
                </div>
                ...
                <div class="mt-6 pt-4 sm:pt-6 border-t border-gray-200">
                    <p class="text-xs text-center text-gray-500 mb-2">Comptes de test:</p>
                    <div class="flex flex-wrap justify-center gap-1 sm:gap-2 text-xs">
