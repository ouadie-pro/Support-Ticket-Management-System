    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Détails Tickets</h3>
            </div>
            <div class="divide-y divide-gray-200 max-h-64 overflow-y-auto">
                ...
                @empty
                <div class="px-6 py-4 text-center text-gray-500">Aucune donnée</div>
                @endforelse
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-md overflow-hidden">
            <div class="px-6 py-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Détails Réclamations</h3>
            </div>
            <div class="divide-y divide-gray-200 max-h-64 overflow-y-auto">
