...
@section('title', 'Créer une catégorie d\'article')

@section('content')
<div class="bg-white rounded-lg shadow-md p-6">
    <h1 class="text-2xl font-bold mb-6">Créer une catégorie d'article</h1>
    
    <form action="{{ route('categorieArticles.store') }}" method="POST">
        @csrf
        ...
        <div class="mt-6 flex space-x-4">
            ...
            <a href="{{ route('categorieArticles.index') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded hover:bg-gray-400">Annuler</a>
        </div>
    </form>
</div>
@endsection
