...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <form action="{{ route('tickets.store') }}" method="POST" class="p-4 sm:p-6 space-y-4 sm:space-y-6">
            @csrf
            ...
            <div>
                ...
                <select name="categorie_id" id="categorie_id" class="w-full px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base">
            ...
            <div>
                ...
                <select name="priorite" id="priorite" class="w-full px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base">
            ...
            <div>
                ...
                <textarea name="description" id="description" required rows="5" class="w-full px-4 py-2 sm:py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm sm:text-base"
            ...
            <div class="flex flex-col sm:flex-row items-center justify-between gap-3 pt-4 border-t border-gray-200">
                <a href="{{ route('tickets.index') }}" class="px-4 sm:px-6 py-2 bg-gray-200 hover:bg-gray-300 text-gray-700 font-medium rounded-lg transition text-sm sm:text-base w-full sm:w-auto text-center">
                    <i class="fas fa-arrow-left mr-2"></i>Annuler
                </a>
                <button type="submit" class="px-4 sm:px-6 py-2 sm:py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition text-sm sm:text-base w-full sm:w-auto">
