...
<div class="space-y-6">
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Ticket {{ $ticket->numero }}</h1>
            <p class="text-gray-500 mt-1">Créé le {{ $ticket->created_at->format('d/m/Y à H:i') }}</p>
        </div>
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
                    <h3 class="text-lg font-semibold text-gray-900">{{ $ticket->sujet }}</h3>
                </div>
                <div class="p-6">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        ...
                        <p class="font-medium text-gray-900">{{ $ticket->categorie->libelle ?? '-' }}</p>
                    </div>
                    <div>
                        <label class="text-sm text-gray-500">Assigné à</label>
                        <p class="font-medium text-gray-900">{{ $ticket->agent->nom ?? 'Non assigné' }}</p>
                    </div>
                    <div>
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <form method="POST" action="{{ route('tickets.assign', $ticket->id) }}">
                        ...
                        <select name="assigne_a" class="w-full px-3 py-2 border border-gray-300 rounded-lg mb-2">
            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="p-4 flex flex-wrap gap-2">
                    ...
                    <form method="POST" action="{{ route('tickets.update-status', $ticket->id) }}" class="inline">
                        ...
                        <button type="submit" class="px-3 py-2 bg-gray-600 hover:bg-gray-700 text-white text-sm rounded-lg">
